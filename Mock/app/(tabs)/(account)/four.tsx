...
const Profile = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      const response = await axios.post(`${ApiUrl}:8000/api/logout/`,
      {},
      {
        headers: {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.option} onPress={handleAccountSettings}>
        <Ionicons name="settings-outline" size={24} color="#767575" style={styles.icon} />
        <Text style={[styles.optionText, styles.textColor, styles.slenderText]}>Account Settings</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.option} onPress={handleReportProblem}>
        <Ionicons name="alert-circle-outline" size={24} color="#767575" style={styles.icon} />
        <Text style={[styles.optionText, styles.textColor, styles.slenderText]}>Report a Problem</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.option} onPress={handleTellAFriend}>
        <Ionicons name="share-social-outline" size={24} color="#767575" style={styles.icon} />
        <Text style={[styles.optionText, styles.textColor, styles.slenderText]}>Tell a Friend</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.option} onPress={handleLogout}>
        <Ionicons name="log-out-outline" size={24} color="#767575" style={styles.icon} />
        <Text style={[styles.optionText, styles.textColor, styles.slenderText]}>Log Out</Text>
      </TouchableOpacity>
      ...
      <View style={styles.bottomOptions}>
        ...
        <TouchableOpacity style={styles.bottomOption} onPress={handlePrivacy}>
          <Text style={[styles.bottomOptionText, styles.textColor]}>Privacy</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.bottomOption} onPress={handleHelpCenter}>
          <Text style={[styles.bottomOptionText, styles.textColor]}>Help Center</Text>
        </TouchableOpacity>
      </View>
